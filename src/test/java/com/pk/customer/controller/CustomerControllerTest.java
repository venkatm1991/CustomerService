...
public class CustomerControllerTest {
	...
	public void addCustomer() throws Exception {
		...
		when(objectConvertUtil.converToCustomerResponse(anyString(),anyString())).thenReturn(customerResponse);
		mockMvc.perform(post("/v1/api/customer").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON).content("{\r\n"
	...
	public void addCustomerError() throws Exception {
		...
		when(customerPublisherService.publishMessage(any())).thenReturn("Message published");
		when(objectConvertUtil.converToCustomerResponse(anyString(),anyString())).thenReturn(customerResponse);
		mockMvc.perform(post("/v1/api/customer").header("Transaction-Id", "CS9URF").header("Activity-Id", "CS00546").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON).content("{\r\n"
				+ "  \"customerNumber\": \"AF46375GE4\",\r\n"
				+ "  \"firstName\": \"Venkat232344\",\r\n"
				+ "  \"lastName\": \"Mandalapu46578\",\r\n"
				+ "  \"birthdate\": \"1990/\",\r\n"
