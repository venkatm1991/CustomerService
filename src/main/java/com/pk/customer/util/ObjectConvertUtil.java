...
public class ObjectConvertUtil {
  ...
  public ErrorLogEntity convertErrorLog(
      Payload payload, String exceptionType, String exceptionMessage) {
  ...
  public Payload converToPayload(
      CustomerRequest customerRequest, String tractionId, String activityId) {
