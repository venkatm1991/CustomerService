...
public class CustomerMaskUtil {
  ...
  public CustomerRequest convert(CustomerRequest customerRequest) {
    ...
    customerMaskRequest.setCustomerNumber(
        customerRequest
            .getCustomerNumber()
            .replaceAll(CustomerMaskConstants.MASK_CUSTOMER_NUMBER, maskChar));
    customerMaskRequest.setCustomerStatus(customerRequest.getCustomerStatus());
    customerMaskRequest.setEmail(
        customerRequest.getEmail().replaceAll(CustomerMaskConstants.MASK_EMAIL, maskChar));
